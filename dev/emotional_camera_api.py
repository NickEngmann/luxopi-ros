...
with dai.Device() as device:
    ...
    show_preview = False  # Flag to control whether to show camera preview
        ...
        if msgs is not None:
            ...
            for i, detection in enumerate(detections):
                ...
                if show_preview:
                    ...
                    # Print emotion to terminal instead
                    spatial_info = ""
                    if stereo:
                        spatial_info = f" (Z: {detection.spatialCoordinates.z/1000:.2f} m)"
                    print(f"Person detected - Emotion: {emotion_name}{spatial_info}")
