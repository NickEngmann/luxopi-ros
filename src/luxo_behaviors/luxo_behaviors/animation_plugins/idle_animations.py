...
class GentleSwayAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.0],                          # Start at home - gentle
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.0]                           # Home 2 - gentle
        ]
...
class CuriousExplorationAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 13.0],                    # Start at home - moderate
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 13.0]                     # Home directly - moderate
        ]
...
class BreathingAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 10.5],                    # Rest position - very gentle
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 10.0]                     # Home directly - slowest
        ]
...
class AttentiveListeningAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.5],                    # Home - moderate
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.5]                     # Home 2 - moderate
        ]
...
class PlayfulBobAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 14.0],                          # Home - moderate
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 14.0]                           # Home 2 - moderate
        ]
...
class ScanningWatchAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [0.0, -0.55, 1.2, 1.0, -2.0, 13.0],                          # Home - moderate
            ...
            [0.0, -0.55, 1.2, 1.0, -2.0, 13.0]                          # Home directly - moderate
        ]
...
class SettlingAdjustAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [0.0, -0.55, 1.2, 1.0, -2.0, 12.0],                                   # Starting position - gentle
            ...
            [0.0, -0.55, 1.2, 1.0, -2.0, 12.0]                                    # Already home - gentle
        ]
...
class DreamyDriftAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [0.0, -0.55, 1.2, 1.0, -2.0, 10.0],                           # Home - slowest
            ...
            [0.0, -0.55, 1.2, 1.0, -2.0, 10.0]                            # Home directly - slowest
        ]
...
class NeckStretchAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.0],                    # Home - gentle
...
class YawningStretchAnimation(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 12.0]                     # Home directly - gentle
        ]
...
class ShoulderShimmy(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            ...
            [base_pos, -0.55, 1.2, 1.0, -2.0, 14.0]                     # Home directly - moderate
        ]
...
class LookAroundCasual(AnimationPlugin):
    ...
    def get_keyframes(self) -> Tuple[List[List[float]], List[float]]:
        ...
        keyframes = [
            [base_pos, -0.55, 1.2, 1.0, -2.0, 13.0],                    # Home - moderate
