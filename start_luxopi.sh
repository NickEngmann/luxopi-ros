...
export LUXOPI_ENABLE_APDS9960="${LUXOPI_ENABLE_APDS9960:-true}"
...
export LUXOPI_SPANISH_MODE="${LUXOPI_SPANISH_MODE:-true}"
...
get_launch_args() {
    echo "use_hardware:=$LUXOPI_USE_HARDWARE" \
         ...
         "spanish_mode:=$LUXOPI_SPANISH_MODE"
}
...
print_configuration() {
    ...
    log "  - Spanish Mode: $LUXOPI_SPANISH_MODE"
    log "=========================="
}
